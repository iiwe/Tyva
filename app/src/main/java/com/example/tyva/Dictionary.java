...
public class Dictionary extends AppCompatActivity {
    String[] russian_words = {"Здравствуйте!", "Да", "Нет", "Доброе утро!", "Добрый день!",
            "Добрый вечер!", "Меня зовут…, а вас?","До свидания!", "До скорого!", "Я турист",
            ...
            "Нам нужен...", "Где можно покушать?", "Очень вкусно!"};
    String[] tyva_words = {"Экии!", "Ийе", "Чок", "Эртенгиниӊ мендизи-биле!", "Хүндүскүнүӊ мендизи-биле!",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colors[1] = Color.parseColor("#359967CC");
